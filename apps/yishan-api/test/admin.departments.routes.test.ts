...
import adminDeptsPlugin from '../src/core/routes/api/v1/admin/departments/index.ts'
import registerDeptSchemas from '../src/core/schemas/department.ts'
...
import { DeptService } from '../src/core/services/dept.service.ts'
