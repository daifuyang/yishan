...
import adminRolesPlugin from '../src/core/routes/api/v1/admin/roles/index.ts'
import registerRoleSchemas from '../src/core/schemas/role.ts'
...
import { RoleService } from '../src/core/services/role.service.ts'
