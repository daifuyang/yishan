...
export const PERMISSION_CODES = {
  ...
  // Shop
  SHOP_CATEGORY_LIST: "shop:category:list",
  ...
  SHOP_ATTRIBUTE_LIST: "shop:attribute:list",
  SHOP_ATTRIBUTE_CREATE: "shop:attribute:create",
  SHOP_ATTRIBUTE_UPDATE: "shop:attribute:update",
  SHOP_ATTRIBUTE_DELETE: "shop:attribute:delete",
  SHOP_PRODUCT_LIST: "shop:product:list",
  SHOP_PRODUCT_CREATE: "shop:product:create",
  SHOP_PRODUCT_UPDATE: "shop:product:update",
  SHOP_PRODUCT_DELETE: "shop:product:delete",
  SHOP_SKU_LIST: "shop:sku:list",
  SHOP_SKU_CREATE: "shop:sku:create",
  SHOP_SKU_UPDATE: "shop:sku:update",
  SHOP_SKU_DELETE: "shop:sku:delete",
  SHOP_ORDER_LIST: "shop:order:list",
  SHOP_ORDER_CREATE: "shop:order:create",
  SHOP_ORDER_UPDATE: "shop:order:update",
  SHOP_ORDER_DELETE: "shop:order:delete",

  // Portal
  PORTAL_PAGE_LIST: "portal:page:list",
  PORTAL_PAGE_CREATE: "portal:page:create",
  PORTAL_PAGE_UPDATE: "portal:page:update",
  PORTAL_PAGE_DELETE: "portal:page:delete",
  PORTAL_PAGE_TEMPLATE_LIST: "portal:page-template:list",
  PORTAL_PAGE_TEMPLATE_CREATE: "portal:page-template:create",
  PORTAL_PAGE_TEMPLATE_UPDATE: "portal:page-template:update",
  PORTAL_PAGE_TEMPLATE_DELETE: "portal:page-template:delete",
  PORTAL_ARTICLE_LIST: "portal:article:list",
  PORTAL_ARTICLE_CREATE: "portal:article:create",
  PORTAL_ARTICLE_UPDATE: "portal:article:update",
  PORTAL_ARTICLE_DELETE: "portal:article:delete",
  PORTAL_ARTICLE_PUBLISH: "portal:article:publish",
  PORTAL_ARTICLE_TEMPLATE_LIST: "portal:article-template:list",
  PORTAL_ARTICLE_TEMPLATE_CREATE: "portal:article-template:create",
  PORTAL_ARTICLE_TEMPLATE_UPDATE: "portal:article-template:update",
  PORTAL_ARTICLE_TEMPLATE_DELETE: "portal:article-template:delete",
  PORTAL_CATEGORY_LIST: "portal:category:list",
  PORTAL_CATEGORY_CREATE: "portal:category:create",
  PORTAL_CATEGORY_UPDATE: "portal:category:update",
  PORTAL_CATEGORY_DELETE: "portal:category:delete",
