export const PositionMessageKeys = {
...
export type PositionMessageKey = typeof PositionMessageKeys[keyof typeof PositionMessageKeys];
...
function resolveLocale(acceptLanguage?: string): keyof typeof POSITION_MESSAGES {
...
export function getPositionMessage(key: PositionMessageKey, acceptLanguage?: string): string {
  const locale = resolveLocale(acceptLanguage);
  const bundle = POSITION_MESSAGES[locale];
  return bundle[key] || POSITION_MESSAGES['zh-CN'][key];
}
