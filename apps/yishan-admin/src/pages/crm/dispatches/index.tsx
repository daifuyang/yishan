...
const DispatchPage: React.FC = () => {
  ...
  const columns: ProColumns<any>[] = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size={16}>
          <a onClick={() => loadDetail(record.id)}>处理</a>
        </Space>
      ),
    },
  ];
  ...
  return (
    <PageContainer>
      ...
      >
        <p>
          客户：{detail?.customer?.name}，医院：{detail?.hospital?.hospitalName}
        </p>
        <Form
          form={form}
          layout="vertical"
        ...
        >
          <Space wrap align="start">
            <Form.Item name="hospitalId" label="医院ID">
              <InputNumber />
            </Form.Item>
            <Form.Item name="statusId" label="状态ID">
              <InputNumber />
            </Form.Item>
            <Form.Item name="receiveQq" label="对接QQ">
              <Input />
            </Form.Item>
            <Form.Item name="receiveWechat" label="对接微信">
              <Input />
            </Form.Item>
          </Space>
          <Form.Item name="image" label="重单截图URL">
            <Input />
          </Form.Item>
        ...
        >
          <Form.Item name="content" label="新增回复">
        ...
        >
          <Form.Item name="content" label="新增跟进日志">
            <Input.TextArea rows={3} />
          </Form.Item>
