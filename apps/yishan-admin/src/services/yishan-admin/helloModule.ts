...
/** Hello 模块健康检查 提供模块可用性检测端点 GET /api/modules/hello/v1/admin/ */
...
/** Hello 模块鉴权示例 演示带鉴权的模块端点规范 GET /api/modules/hello/v1/admin/me/ */
...
/** Hello 模块回显示例 演示带请求体校验和鉴权的模块端点 POST /api/modules/hello/v1/echo */
...
/** Hello 模块健康检查 提供模块可用性检测端点 GET /api/modules/hello/v1/ping */
