...
export const AttachmentLibraryModal: React.FC<AttachmentLibraryModalProps> = ({
  ...
  const [selectedMap, setSelectedMap] = useState<Record<string, Attachment>>(
    {},
  );
  ...
  const [editingAttachment, setEditingAttachment] = useState<Attachment>();
  const [deletingAttachment, setDeletingAttachment] = useState<Attachment>();
